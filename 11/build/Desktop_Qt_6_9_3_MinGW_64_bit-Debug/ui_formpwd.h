...
public:
    ...
    void setupUi(QWidget *Formpwd)
    {
        ...
        Formpwd->setMinimumSize(QSize(400, 300));
        Formpwd->setMaximumSize(QSize(400, 300));
...
"}"));
        ...
        pwdstackedWidget->setCurrentIndex(2);
    ...
    {
        Formpwd->setWindowTitle(QString());
#if QT_CONFIG(whatsthis)
        pwdstackedWidget->setWhatsThis(QCoreApplication::translate("Formpwd", "\345\277\230\350\256\260\345\257\206\347\240\201-\344\277\256\346\224\271\345\257\206\347\240\201", nullptr));
