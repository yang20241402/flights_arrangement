...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        Form->resize(431, 340);
        Form->setMinimumSize(QSize(431, 340));
        Form->setMaximumSize(QSize(431, 340));
...
"}"));
        ...
        registerstackedWidget->setCurrentIndex(1);
    ...
    {
        Form->setWindowTitle(QCoreApplication::translate("Form", "\347\224\250\346\210\267\346\263\250\345\206\214", nullptr));
