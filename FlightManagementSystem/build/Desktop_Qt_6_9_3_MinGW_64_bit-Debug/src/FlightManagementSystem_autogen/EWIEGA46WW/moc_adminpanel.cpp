...
template <> constexpr inline auto AdminPanel::qt_create_metaobjectdata<qt_meta_tag_ZN10AdminPanelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'switchToFlightManagement'
...
void AdminPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->switchToFlightManagement(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdminPanel::*)()>(_a, &AdminPanel::switchToFlightManagement, 0))
            return;
    }
}
...
// SIGNAL 0
void AdminPanel::switchToFlightManagement()
{
